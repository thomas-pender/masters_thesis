...
To this end, let $\hat G = \{\chi_g : g \in G\}$ be the collection of 
irreducible characters\Fnote{irr-chars} of the group $G$, i.e. the dual group of $G$. Following \cite{ddg-schemes}, we make the following definitions for each $g \in G$: 
\[
...
\begin{defin}
 ...
 \ref{general-weighing-scheme-theorem-2} are called {\it generalized weighing
   schemes}\index{generalized weighing schemes}. 
\end{defin}
