 ...
 \begin{defin}\label{ass-scheme-def}\index{association scheme}
  ...
  \begin{defenum}
   ...
   \item Given $(x,y) \in R_k$, the number of $z \in X$ such that $(x,z) \in
     ...
     the {\it intersection numbers}\index{intersection numbers} of the scheme. 
  \end{defenum}
...
\subsection{Adjacency Algebras} 
 ...
 \begin{defin}
  ...
  for which they are primitive idempotents.\Anote{dual-scheme} We therefore also
  call the adjacency matrices the {\it Schur idempotents}\index{Schur
    idempotents} of the scheme. 
 \end{defin}
 ...
 are called the {\it multiplicities}\index{multiplicities} of the scheme. 
 ...
 $i,j \in \{0, \dots, d\}$, called the {\it eigenvalues}\index{eigenvalues of a
   scheme} and {\it dual-eigenvalues}\index{dual-eigenvalues of a scheme} of the
 ...
 these matrices the {\it first} and {\it second character
   tables}\index{character tables} of the scheme. By what has been said, we have
 ...
 called the {\it $i$-th intersection matrix}\index{intersection matrix}. It then
 ...
 {\it standard form}\index{standard form} if the first entry is 1. 
